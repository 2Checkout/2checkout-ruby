DEPRECATED!!! This SDK can only be used with the legacy 2Checkout platform which is depreciated. Please use [2checkout-ruby-sdk](https://github.com/2Checkout/2checkout-ruby-sdk) with the current 2Checkout platform.
=====================
